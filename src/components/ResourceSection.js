...
const ResourceSection = () => {
  return (
    <>
      <div className="pt-[70px] pb-[58px] md:pt-[160] md:mb-[100px] ">
        ...
        <div className=" title-border  max-w-[392px] before:bg-[#000000] mb-[40px]">
          ...
          <div className="row1  m-auto" >
            ...
            <div className="  col-12 md:max-w-[58.333333%] mt-[24px] md:mt-0  flex justify-center md:justify-normal items-center  ">
              ...
              <button className="resourceBtn pt-[13px] pb-[13px] pl-[30px] pr-[30px] max-w-full md:max-w-[180px] md:max-h-[48px] leading-[24px] md:leading-[22px] text-[14px] font-bold 
